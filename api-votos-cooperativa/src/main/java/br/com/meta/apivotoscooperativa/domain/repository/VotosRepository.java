...
public interface VotosRepository extends JpaRepository<Votos, Long> {
    // Query que conta quantas vezes o associado_id votou em uma sessão especifica retornando em inteiro a quantidade,
    // onde e buscado na tabela votos o id passado e o numero da sessão retornando se ja votou ou não.

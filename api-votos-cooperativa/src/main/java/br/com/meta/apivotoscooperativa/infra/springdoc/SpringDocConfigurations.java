    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API Rest votos cooperativa para votação de pautas em sessão, contendo as funcionalidades de CRUD: Associados e pautas, com funções de abrir uma sessão para uma pauta especifica e iniciar uma votação para a aceitação da ideia preescrita na pauta.\n " +
